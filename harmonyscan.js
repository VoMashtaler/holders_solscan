...
async function downloadHolders() {
  const tokenAddress = document.querySelector("#tokenAddressInputHar").value;
  ...
  document.querySelector("#downloadButtonHar").disabled = true;
  ...
  link.setAttribute("download", "Harmony.csv");
  link.click();

  document.querySelector("#loadingSpinner").style.display = "none";
  document.querySelector("#downloadButtonHar").disabled = false;
}

document.querySelector("#downloadButtonHar").addEventListener("click", downloadHolders);
